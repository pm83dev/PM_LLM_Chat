...
exports.EDIT_FORMAT_INSTRUCTION = void 0;
exports.getStackGuidance = getStackGuidance;
exports.buildFixSystemPrompt = buildFixSystemPrompt;
exports.buildEditSystemPrompt = buildEditSystemPrompt;
function getStackGuidance(lang, filename) {
    if (lang === "typescript" ||
        lang === "html" ||
...
function buildFixSystemPrompt(lang, filename) {
    return [
...
function buildEditSystemPrompt(lang, filename) {
    return [
        `You are a code transformation engine. Language: ${lang}. File: ${filename}.`,
        getStackGuidance(lang, filename),
 ...
 */
exports.EDIT_FORMAT_INSTRUCTION = [
